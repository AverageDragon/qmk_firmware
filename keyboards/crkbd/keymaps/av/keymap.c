...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_split_3x6_3(
    KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,            KC_T,            KC_Y,        KC_U,    KC_I,    KC_O,     KC_P,    KC_LWIN,
    KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,            KC_G,            KC_H,        KC_J,    KC_K,    KC_L,     KC_SCLN, KC_DEL,
    KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,            KC_B,            KC_N,        KC_M,    KC_COMM, KC_DOT,   KC_SLSH, KC_LALT,
    /*       ,        */       MO(1),   KC_LSFT,         KC_SPC,          KC_ENT,      KC_BSPC, MO(2)    /*        ,        */
  ),
  [1] = LAYOUT_split_3x6_3(
    _______, KC_1,    KC_2,    KC_3,    KC_4,            KC_5,            KC_6,        KC_7,    KC_8,    KC_9,     KC_0,    KC_PSCR,
    RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, KC_HOME,         KC_PGUP,         KC_LEFT,     KC_DOWN, KC_UP,   KC_RIGHT, XXXXXXX, _______,
    RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, KC_END,          KC_PGDN,         KC_LBRC,     XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, KC_RALT,
    /*       ,        */       _______, KC_RSFT,         _______,         _______,     _______, XXXXXXX  /*        ,        */
  ),
  [2] = LAYOUT_split_3x6_3(
    _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,          KC_PERC,         KC_CIRC,     KC_AMPR, KC_ASTR, KC_LPRN,  KC_RPRN, KC_INS,
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,           KC_F6,           KC_MINS,     KC_EQL,  KC_QUOT, KC_LCBR,  KC_RCBR, _______,
    KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,          KC_F12,          KC_PAUS,     KC_GRV,  KC_BSLS, KC_LBRC,  KC_RBRC, _______,
